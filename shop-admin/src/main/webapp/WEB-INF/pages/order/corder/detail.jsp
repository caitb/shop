                                ...
                                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="" id="createTime"><fmt:formatDate value="${order.pfCorder.createTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" /></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="" id="payTime"><fmt:formatDate value="${order.pfCorder.payTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" /></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <c:if test="${order.pfCorder.payStatus == 1 && order.pfCorder.shipStatus == 0}">
                                                    <span>未发货</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value" style="border-top: 3px dotted #DCEBF7;">
                                                <span class="" id="consignee">${order.pfCorderConsignee.consignee}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="bgarea" id="address">${order.pfCorderConsignee.provinceName}${order.pfCorderConsignee.cityName}${order.pfCorderConsignee.regionName}${order.pfCorderConsignee.address}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="bgarea" id="mobile">${order.pfCorderConsignee.mobile}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="bgarea" id="zip">${order.pfCorderConsignee.zip}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="bgarea" id="shipAmount">${order.pfCorder.shipAmount}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="bgarea" id="productAmount">${order.pfCorder.productAmount}</span>
                                            </div>
                                        </div>
