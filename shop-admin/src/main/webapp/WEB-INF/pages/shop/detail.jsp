                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="" id="name">${shop.sfShop.name}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="" id="realName">${shop.comUser.realName}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="" id="explanation">${shop.sfShop.explanation}</span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> 总浏览量 </div>

                                            <div class="profile-info-value">
                                                <span class="" id="pageviews">${shop.sfShop.pageviews}</span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> 呐喊量 </div>

                                            <div class="profile-info-value">
                                                <span class="" id="linkmanIDCard">${shop.sfShop.shoutNum}</span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> 总成交量 </div>
                                        ...
                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> 分佣金额 </div>
                                        ...
                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> 店铺背景 </div>

                                            <div class="profile-info-value">
                                                <span class="" id="shopBg"><fmt:formatDate value="${user.comUser.createTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" /></span>
                                            </div>
                                        </div>
