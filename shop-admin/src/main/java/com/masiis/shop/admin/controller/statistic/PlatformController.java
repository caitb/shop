...
public class PlatformController {
    ...
    @ResponseBody
    public Object list(HttpServletRequest request, String beginTime, String endTime){
      try {
          Date currDate = null;
          if(StringUtils.isBlank(beginTime)){
              currDate = new Date();
              SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
              beginTime = sdf.format(currDate) + " 00:00:00";
              endTime  = sdf.format(currDate)  + " 23:59:59";
          }else{
          ...
          //注册用户量
          List<StatisticUser> userList = statisticUserService.userList(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //新增用户量
          List<StatisticUser> newUserList = statisticUserService.newUserList(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //平台使用用户量（人）（麦链合伙人：合伙人数；）
          List<StatisticUser> useList = statisticUserService.useList(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //平台使用用户量（人）（麦链合伙人：新增合伙人数；）
          List<StatisticUser> newUseList = statisticUserService.newUseList(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链商城购买人数
          List<StatisticUser> cityNum = statisticUserService.cityNum(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链商城新增购买人数
          List<StatisticUser> newCityNum = statisticUserService.newCityNum(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链合伙人成交订单量,成交金额
          List<StatisticOrder> selectOrder = statisticUserService.selectOrder(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链合伙人新增成交订单量,新增成交金额
          List<StatisticOrder> newSelectOrder = statisticUserService.newSelectOrder(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链商城<StatisticOrder>成交订单量,成交金额
          List<StatisticOrder> cityOrder = statisticUserService.cityOrder(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
          //麦链商城新增成交订单量,新增成交金额
          List<StatisticOrder> newCityOrder = statisticUserService.newCityOrder(beginTime, endTime, WxPropertiesUtils.getStringValue("wx.conf.sf.APPID"));
