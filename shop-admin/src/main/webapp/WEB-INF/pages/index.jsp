...
<head>
    ...
    <!--[if IE 7]>
    <link href="<%=basePath%>static/ace/css/font-awesome-ie7.min.css" rel="stylesheet"/>
    <![endif]-->

    <!-- page specific plugin styles -->

    <!-- ace styles -->
    <link href="<%=basePath%>static/ace/css/ace.min.css" rel="stylesheet"/>
    <link href="<%=basePath%>static/ace/css/ace-rtl.min.css" rel="stylesheet"/>
    <link href="<%=basePath%>static/ace/css/ace-skins.min.css" rel="stylesheet"/>

    <!--[if lte IE 8]>
    <link href="<%=basePath%>static/ace/css/ace-ie.min.css" rel="stylesheet"/>
    <![endif]-->
            ...
            <ul class="nav ace-nav">
                ...
                <li class="green">
                    ...
                    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="#">
                                <img src="<%=basePath%>static/ace/avatars/avatar.png" class="msg-photo"
                                     alt="Alex's Avatar"/>
										<span class="msg-body">
                        ...
                        <li>
                            <a href="#">
                                <img src="<%=basePath%>static/ace/avatars/avatar3.png" class="msg-photo"
                                     alt="Susan's Avatar"/>
										<span class="msg-body">
											<span class="msg-title">
                        ...
                        <li>
                            <a href="#">
                                <img src="<%=basePath%>static/ace/avatars/avatar4.png" class="msg-photo"
                                     alt="Bob's Avatar"/>
										<span class="msg-body">
											<span class="msg-title">
...
<script src="<%=basePath%>static/ace/js/jquery.dataTables.min.js"></script>
<script src="<%=basePath%>static/ace/js/jquery.dataTables.bootstrap.js"></script>
