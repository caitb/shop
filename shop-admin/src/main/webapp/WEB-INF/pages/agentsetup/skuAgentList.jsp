                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer no-margin-top">
                                        <div class="col-xs-5 col-sm-5 col-sm-offset-4">
                                            ...
                                            <button class="btn btn-sm btn-info pull-left ok" id="submitBrandForm">
                                                确认
                                            </button>
                                        </div>
                                    </div>
...
<script>
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.reward_unit_price){
                                return row.reward_unit_price;
                            }
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.freeman_upper_num){
                                return row.freeman_upper_num;
                            }
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.is_upgrade == 0){
                                return '否'
                            }
                            if(row && row.is_upgrade == 1){
                                return '是'
                            }
                        }
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.is_show == 0){
                                return '否'
                            }
                            if(row && row.is_show == 1){
                                return '是'
                            }
                        }
                    },
                    ...
                    },
                    {
                        ...
                        formatter: function(value, row, index){
                            var arr = [];
                            arr.push('<a class="edit" href="javascript:void(0);">编辑</a>');
                            return arr.join(' ');
                        },
                        events: {
                            'click .edit': function(e, value, row, index){
                                parent.window.$('#myTabbable').closeTab('agentsetup-');
                                parent.window.$('#myTabbable').add('agentsetup-', '代理设置', '<%=basePath%>skuAgent/edit.shtml?id='+row.id);
                            },
                        }
                    }
                ]
    ...
    $('#addBtn').on('click', function(){
        parent.window.$('#myTabbable').closeTab('agentsetup-');
        parent.window.$('#myTabbable').add('agentsetup-', '代理设置', '<%=basePath%>skuAgent/add.shtml');
    });
