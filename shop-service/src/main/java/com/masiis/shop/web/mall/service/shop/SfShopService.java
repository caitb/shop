...
public class SfShopService {
    ...
    public String createShopPoster(Long userId, String basePath){
        try {
            ...
            SfShop sfShop =   getSfShopByUserId(comUser.getId());
            /**
             * 获取海报
             */
            //获取海报1: 海报已存在,直接返回
            ...
            String posterDirPath = basePath+"static/images/poster"; //basePath:request.getServletContext().getRealPath("/")
            ...
            if(StringUtils.isBlank(sfShop.getQrCode())){
                ...
                if(qrcodeResult[1] == null) throw new BusinessException("合伙人获取店铺二维码失败![comUser="+comUser+"][shopId="+sfShop.getId()+"]");
