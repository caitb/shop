package com.masiis.shop.web.mall.service.qrcode;
 ...
 */
@Service
public class WeiXinSFQRCodeService {

    private final static Log log = LogFactory.getLog(WeiXinSFQRCodeService.class);
