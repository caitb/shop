...
<div id="wrap">
    <div class="main">
        ...
        <div id="box">
            ...
            <p onclick="javascript:window.location.replace('<%=basePath%>userCenterController/stockBorder');"><span><b></b><img src="<%=basePath%>static/images/icon_49.png" alt="">进货订单</span><span><img src="<%=basePath%>static/images/right.png" alt=""></span></p>
