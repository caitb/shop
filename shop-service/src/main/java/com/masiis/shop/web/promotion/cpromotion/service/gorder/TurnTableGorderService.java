...
public class TurnTableGorderService {
    ...
    public Integer receiveGift(ComUser comUser, Long addressId, Integer turnTableId, Integer giftId){
        ...
        //领取
        receiveGiftAddGorder(comUser,addressId,turnTableId,giftId);
        //领取后的操作
        return null;
    }
     ...
     * @param addressId
     */
    private void receiveGiftAddGorder(ComUser comUser,Long addressId,Integer turnTableId, Integer giftId){
        //插入订单
        SfGorder sfGorder = gorderService.addGorder(comUser,turnTableId,giftId, SfGorderTypeEnum.ORDER_TURN_TABLE);
        //插入订单明细
        gorderItemService.addGorDerItem(sfGorder.getId(),SfGorderTypeEnum.ORDER_PROMOTION,turnTableId,giftId);
        //插入订单操作日志
    ...
    private void receiveGiftAfterOpertion(Integer changeTimes,Long userId,Integer turnTableId,Integer turnTableRuleId){
        //用户转盘增加已抽奖次数，减少未抽奖次数
