package com.masiis.shop.web.platform.controller.wxevent;

import com.alibaba.fastjson.JSONObject;
import com.masiis.shop.common.beans.wx.event.event.WxBaseMessage;
import com.masiis.shop.common.beans.wx.event.event.WxEventBody;
import com.masiis.shop.common.beans.wx.event.event.WxEventCheck;
import com.masiis.shop.common.util.HttpClientUtils;
import com.masiis.shop.common.util.PropertiesUtils;
import com.masiis.shop.common.util.SHAUtils;
import com.masiis.shop.common.util.WxPropertiesUtils;
import com.masiis.shop.common.beans.wx.event.menu.Button;
import com.masiis.shop.common.beans.wx.event.menu.Menu;
import com.masiis.shop.web.platform.service.wxevent.WxEventService;
...
public class WxEventController extends BaseController {
    ...
    public static void main(String... args) throws UnsupportedEncodingException {
        ...
        String createMenu = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token=vbWgrzJ4wPjXvryyK7BepgYXwGczuNl_l_TWBdPPVTL69j_QkNBKnykLsPLUdmAGpYTO9wc7sljOTn22iybVAFNJekUVPD3SGUiMI5Jn9wnlg5eau5SYvcJ3j0UcAThKSPYaACAHEN";
        Menu menu = new Menu();
