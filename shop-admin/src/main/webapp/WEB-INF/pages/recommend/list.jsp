...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            url: '<%=basePath%>recommend/list.do',
            //height: getHeight(),
            locale: 'zh-CN',
            striped: true,
            //multipleSearch: true,
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row.presenteeUser && row.presenteeUser.realName){
                                return row.presenteeUser.realName;
                            }
                        }
                    },
                    {
                    ...
                    {
                        field: 'presenteePUser',
                        title: '上级',
                        footerFormatter: totalNameFormatter,
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row.presenteePUser && row.presenteePUser.realName){
                                return row.presenteePUser.realName;
                            }
                        }
                    },
                    {
