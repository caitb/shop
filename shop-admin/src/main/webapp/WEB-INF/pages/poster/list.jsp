                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div>
                                    <input type="text" class="form-controller" id="realName" name="realName" placeholder="创建海报的用户名称">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-sm-offset-0">
                                                    ...
                                                    <div class="profile-user-info profile-user-info-striped">
                                                        ...
                                                        <div class="profile-info-row">
                                                            ...
                                                            <div class="profile-info-value">
                                                                <span class="editable editable-click" id="reaName"> </span>
                                                            </div>
                                                        </div>
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.shareParamId){
                                return  row.shareParamId;
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            if(row && row.posterName){
                               // return row.baseUrl+ row.posterName;
                               return '<img src="http://file.qc.masiis.com/static/user/poster/'+row.posterName+'" class="img-rounded" style="width:10%"> ';
                            }
                        }
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            var sHtm  = '<a class="delete" href="javascript:void(0);">删除</a>';
                            return sHtm;
                        },
                        events: {
                            'click .delete': function(e, value, row, index){
                                $.ajax({
                                    url: '<%=basePath%>poster/delete.do',
                                    data:{id:row.id},
                                    success: function (){
                                        $('#table').bootstrapTable('refresh');
                                    }
                                });
                                <%--parent.window.$('<%=basePath%>poster/delete.do?id='+row.id);--%>
                            }
                        }
                    }
                ]
