...
//        PfUserSku parentUserSku = pfUserSkuMapper.selectByPrimaryKey(pfUserSku.getPid());
//        if (parentUserSku.getUserId() != null && parentUserSku.getUserId() > 0) {
//            order.setUserPid(parentUserSku.getUserId());
//        } else {
//            order.setUserPid(0l);
//        }
