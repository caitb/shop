...
<%--        <a href="index.html"><img src="${path}/static/images/xq_rt.png" alt=""></a>--%>
    ...
    <div class="sec1">
        <div>
            <h1>￥${pfBorder.receivableAmount}</h1>
            <p>您需要在${latestTime}前将￥${pfBorder.receivableAmount}转到麦链合伙人对公账户。</p>
        </div>
        <p>*请在汇款单的附言处注明“${orderItem.skuName}合伙申请${pfBorder.receivableAmount}元套餐+您的手机号”（<span>非常重要！</span>）</p>
