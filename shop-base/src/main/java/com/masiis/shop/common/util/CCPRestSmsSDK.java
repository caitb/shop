...
public class CCPRestSmsSDK {
	 ...
	 * @param contents       短信内容
	 */
	public static void sendSMS(String phoneNum, String smsTemplateId, String[] contents){
		//初始化SDK
		...
		//设置应用ID
		smsSDK.setAppId("aaf98f8952624f61015262a5751c00bf");
	 ...
	 * @return
	 */
	public static String[] sendSMSWithResult(String phoneNum, String smsTemplateId, String[] contents){
		//初始化SDK
		CCPRestSmsSDK smsSDK = new CCPRestSmsSDK();
		//初始化服务器地址和端口
		smsSDK.init("app.cloopen.com", "8883");
