                                                    ...
                                                    <form id="spuMainForm">
                                                        <div class="profile-user-info profile-user-info-striped">
                                                            ...
                                                            <div class="profile-info-row">
                                                                <div class="profile-info-name"> 团队 </div>
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            url: '<%=basePath%>teamsort/teamSortList.do',
            //height: getHeight(),
            locale: 'zh-CN',
            striped: true,
            //multipleSearch: true,
    ...
    function loadSpu(){
        $.ajax({
            url: '<%=basePath%>brandsort/listTeam.do',
            success: function (listAll){
                listAll = window.eval('('+listAll+')');
                teams = listAll['teamList'];
    ...
    $('#submitSpuMainForm').on('click', function(){
        ...
        $.ajax({
            url: '<%=basePath%>brandsort/addTeam.do',
            data: {id:brandId},
            success: function(result){
                result = window.eval('('+result+')');
