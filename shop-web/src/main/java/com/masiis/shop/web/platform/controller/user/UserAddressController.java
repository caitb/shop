...
public class UserAddressController extends BaseController {
    ...
    public String clickAddressOrReturnToPage(HttpServletRequest request,
        ...
        String redirectBody = userAddressService.getPFOrderPagePath(request,selectedAddressId);
    ...
    public String toChooseAddressPage(HttpServletRequest request,
        ...
        request.getSession().setAttribute(SysConstants.SESSION_ORDER_SUPPLEMENT_PARAM,supplementOrderParamForAddress);
