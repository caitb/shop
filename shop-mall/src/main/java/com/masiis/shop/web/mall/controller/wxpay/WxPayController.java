package com.masiis.shop.web.mall.controller.wxpay;
...
import com.masiis.shop.web.mall.service.wxpay.WxPayService;
...
public class WxPayController extends BaseController {
    ...
    public String wxpayPage(HttpServletRequest request, String param) {
        ...
        try {
            ...
            uniOrder.setSign(WxSFBeanUtils.toSignString(uniOrder));
            // 微信下预付订单,并获取预付订单号
    ...
    private WxPaySysParamReq checkRequestParma(WxPaySysParamReq req, String param) throws UnsupportedEncodingException {
        ...
        if(!WxSFBeanUtils.toSignString(req).equals(req.getSign())){
    ...
    private BrandWCPayReq createBrandWCPayReq(UnifiedOrderRes resObj) {
        ...
        payReq.setNonceStr(WxSFBeanUtils.createGenerateStr());
        payReq.setSignType("MD5");
        payReq.setPackages("prepay_id=" + resObj.getPrepay_id());
        payReq.setPaySign(WxSFBeanUtils.toSignString(payReq));
        return payReq;
    }
}
