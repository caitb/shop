            ...
            window.location.href = path + "/mallmessage/toDetail.shtml?userId=" + $(this).attr("id");
                    ...
                    <div class="wrap">
                        <header class="xq_header">
                            <a href="javascript:void(0)" onclick="javascript:window.location.replace('<%=path%>/sfOrderManagerController/borderManagement.html');"><img src="${path}/static/images/xq_rt.png" alt=""></a>
                            <p>消息中心</p>
                        </header>
                        <!--      消息list-->
                        <main id="shopList">
