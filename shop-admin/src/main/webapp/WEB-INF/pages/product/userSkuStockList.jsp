                                ...
                                <div>
                                    <div id="toolbar" style="float:left;">
                                        <form class="form-inline">
                                                ...
                                                <input type="text" class="form-control" name="skuName" placeholder="商品名称" />
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            locale: 'zh-CN',
            url: '<%=basePath%>agentStock/list.do',
            striped: true,
            //multipleSearch: true,
            ...
            queryParams: function(params){
                ...
                if($('input[name=skuName]').val()) {
                    params.skuName = $('input[name=skuName]').val();
                }
                return params;
            },
