    ...
    <div class="xieyi">
        <div class="back_q" style="margin-top:-166px">
            ...
            <p style="height: 200px;overflow-y: auto;">
                ...
                一、账号注册
                1、用户在代理产品前需要注册一个“麦链合伙人”账号。“麦链合伙人”账号应当使用手机号码绑定注册，请用户使用尚未与“麦链合伙人”账号绑定的手机号码，以及未被“麦士集团：根据本协议封禁的手机号码注册“麦链合伙人”账号。注册后需进行身份证验证的实名认证，通过后即可进行产品代理。 
                二、代理协议
                ...
                五、其他
                1、麦链合伙人郑重提醒用户注意本协议中各项的条款，请用户仔细阅读，自主考虑风险。未成年人应在法定监护人的陪同下阅读本协议。 
                2、本协议的效力、解释及纠纷的解决，适用于中华人民共和国法律。若代理方和麦链合伙人中心之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，代理方同意将纠纷或争议提交麦士集团住所地有管辖权的人民法院管辖。 
