            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div id="modal-dispose" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body no-padding">
                                        <form class="form-horizontal" role="form" id="uaaForm">
                                    ...
                                    <div class="modal-footer no-margin-top">
                                        <div class="col-xs-5 col-sm-5 col-sm-offset-4">
                                            ...
                                            <button class="btn btn-sm btn-info pull-left" id="saveDispose" type="button">
                                                保存
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div id="modal-view" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header no-padding">
                                        <div class="table-header">
                        ...
                        <div id="modal-info" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header no-padding">
                                        <div class="table-header">
                                    ...
                                    <div class="modal-body no-padding">
                                        <div class="form-group">
                                            <label for="remark" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <textarea name="info" id="info" cols="50" rows="5" disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer no-margin-top">
                                        <div class="col-xs-5 col-sm-5 col-sm-offset-4">
                                            <button class="btn btn-sm btn-danger pull-left" id="close" type="button" data-dismiss="modal">
                                                关闭
                                            </button>
                                            <button class="btn btn-sm btn-info pull-left" id="copy" type="button">
                                                复制
                                            </button>
                                        </div>
                                    </div>
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            //height: getHeight(),
            url: '<%=basePath%>userAgentApplication/list.do',
            locale: 'zh-CN',
            striped: true,
            //multipleSearch: true,
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        formatter: function(value, row, index){
                            if(row && row.status == 0){
                                return '<span class="label label-sm label-grey">未处理</span>';
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function(value, row, index){
                            var sHtml = '<a class="copy" href="javascript:void(0);">复制</a>';
                            if(row && row.status == 0){
                                sHtml += '&nbsp;&nbsp;<a class="dispose" href="javascript:void(0);">处理</a>';
                            }else if(row && row.status == 1){
                                sHtml += '&nbsp;&nbsp;<a class="view-remark" href="javascript:void(0);">查看备注</a>';
                            }
                        ...
                        events: {
                            'click .dispose': function(e, value, row, index){
                                $('#uaaForm').find('input[name="id"]').val(row.id);
                                $('#uaaForm').find('input[name="status"]').val(1);
                                $('#modal-dispose').modal('show');
                            },
                            'click .view-remark': function(e, value, row, index){
                                $('#viewRemark').html(row.remark);
                            ...
                            'click .copy': function(e, value, row, index) {
                                var sV  = '姓名: ' + row.name + '\r\n';
                                    ...
                                    sV += '商品名称: ' + row.skuName + '\r\n';
                                    sV += '手机号: ' + row.mobile + '\r\n';
                                    sV += '提交时间: ' + new Date(row.createTime).pattern('yyyy-MM-dd HH:mm:ss') + '\r\n';
                                $('#info').val(sV);
    ...
    $('#saveDispose').on('click', function(){
        ...
        $.ajax({
            url: '<%=basePath%>userAgentApplication/dispose.do',
            type: 'POST',
            data: $('#uaaForm').serialize(),
