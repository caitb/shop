...
public class SfShopManageController extends BaseController {
    ...
    public ModelAndView getPoster(HttpServletRequest request, HttpServletResponse response, Long shopId){
        ...
        try {
            ...
            Element text2Element = new Element(240, 644, font1, new Color(51, 51, 51), "该二维码有效期为");
            Element text3Element = new Element(210, 700, font1, new Color(51, 51, 51), startTime+"-"+endDate);
