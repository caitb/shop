       ...
       <main>
            ...
            <div class="tai">
                <c:if test="${orderMallDetail.sfOrder.orderStatus==0}">
                    <img src="<%=path%>/static/images/icon_65.png" alt="" style="display: block;width: 38px;height: 36px;"><h1>未付款</h1>
                    <p>亲，未付款的订单可以保留7天~~</p>
                </c:if>
                <c:if test="${orderMallDetail.sfOrder.orderStatus==7}">
                    <img src="<%=path%>/static/images/icon_40.png" alt=""  style="display: block;width: 38px;height: 36px;top: 16px;"><h1>待发货</h1>
                    <p>亲，卖家会很快发货~~</p>
                </c:if>
                <c:if test="${orderMallDetail.sfOrder.orderStatus==8}">
                    <img src="<%=path%>/static/images/icon_68.png" alt="" style="display: block;width: 50px;height: 30px;top: 12px;"><h1>已发货</h1>
                    <p>亲，卖家已发货~~</p>
                </c:if>
                <c:if test="${orderMallDetail.sfOrder.orderStatus==3 }">
                    <img src="<%=path%>/static/images/icon_64.png" alt="" style="display: block;width: 38px;height: 49px;top: 15px;"><h1>已完成</h1>
                    <p>亲，交易完成~~</p>
                </c:if>
            </div>
            <div class="kuaidi">
