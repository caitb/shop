...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            locale: 'zh-CN',
            url: '<%=basePath%>material/listGroup.do',
            striped: true,
            //multipleSearch: true,
...
//            if(
//                    (row.is_b_show != '是' || row.is_b_show != '否' && row.is_b_show != undefined)
//                    && (row.is_c_show != '是' || row.is_c_show != '否' && row.is_c_show != undefined)
//            ){
//                $.gritter.add({
//                    title: '消息',
//                    text: '请输入"是"或"否"',
...
//            }
            ...
            $.ajax({
                url: '<%=basePath%>material/updateGroup.do',
                type: 'post',
                data: {id: row.id, name: row.name, isBShow: isBShow, isCShow: isCShow},
