...
public class UpgradeWechatNewsService {
     ...
     * @return
     */
    public Boolean upgradeOrderPaySuccssEntryWaiting(PfBorder pfBorder, List<PfBorderItem> pfBorderItems, PfBorderPayment pfBorderPayment, BOrderUpgradeDetail upgradeDetail) {
        //1.发送升级成功提醒
        upgradeOrderPaySuccessSendWXNotice(pfBorder, pfBorderItems, pfBorderPayment, upgradeDetail);
        //2发送排单提醒
        //2.1给自己发
     ...
     * @return
     */
    public Boolean upgradeOrderPaySuccessSendWXNotice(PfBorder pfBorder, List<PfBorderItem> pfBorderItems, PfBorderPayment pfBorderPayment, BOrderUpgradeDetail upgradeDetail) {
